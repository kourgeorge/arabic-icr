...
The main objective of this work is to maximize the correct segmentation rate while maintaining low complexity and high performance of the system. Maximizing the recognition rate is a secondary objective.\\ 
...
\textbf{Stage 2.} The CPs are investigated and invalid candidate points are filtered out. Then, a scoring correction process is performed to adjust the scoring of the sub-strokes using several rules-based methods.\\
...
[Segmentation point shifting in order to position the segmentation point in a better location]

[subletters strokes recognition]

[complicated recognition i.e. the recognition of the stroke pending the next stroke for example the letter \RL{k-} ]
