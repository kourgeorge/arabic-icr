...
\iftoggle{edit-mode}{\hspace{0pt}\marginpar{HWR Motivation}}{}
Despite long standing predictions that handwriting, and even paper itself, would become obsolete in the age of the digital computer, both persist \cite{noaparast2009persian}.
Although much of the today's data is directly entered into computers using the keyboard, for many tasks, handwriting is still more common used
...
\iftoggle{edit-mode}{\hspace{0pt}\marginpar{Off-line versus On-line Handwriting recognition}}{}
