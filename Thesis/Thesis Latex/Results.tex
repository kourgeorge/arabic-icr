...
\label{chap:results}
The presented work consisted of two main sub-components; the fast Arabic characters classifier and the on-line segmentation system.
...
\section{Letters Classification}
