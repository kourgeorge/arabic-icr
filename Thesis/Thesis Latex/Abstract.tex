...
\chapter*{Abstract}
The cursive and unconstrained nature of the Arabic script, in both printed and handwritten forms, anneals the tasks of segmentation and recognition. 
...
This Work proposes a novel, ongoing, recognition-based segmentation approach for the on-line Arabic script. 
by carrying out the most time consuming recognition process while the stroke is being scribed. 
