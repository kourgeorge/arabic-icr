...
In this work we have proposed and implemented a stroke based, analytic, real-time approach for segmentation and recognition of handwritten on-line Arabic script.
The system have achieved promising results without using contextual information on an open dictionary.

In the first of the thesis, we present a fast approach for Arabic characters classification.
We employ a novel EMD embedding technique into the coefficient domain 

A novel on-line segmentation technique was introduced and used in the analytic phase.
