...
Figure \ref{fig:ha_different} shows several handwritten samples the letter \RL{.h}, in its isolated form, written by several writers.
...
The field of HWR can be classified in several ways, however, the most common categorization is the one that distinguishes between \emph{off-line} (also called \emph{static}) and \emph{on-line} (also called \emph{dynamic}).
...
In Arabic, two or three consequent appearances of the rasm \RL{-b-}, that is common for the letters \RL{-y-}, \RL{-t-} and more, are very similar to the \RL{-s-} letter. 
...
A conference paper titled \textbf{\emph{"Fast Classification of Handwritten On-line Arabic Characters"}} was accepted for publication in the \emph{6th International Conference of Soft Computing and Pattern Recognition} (SoCPaR 2014).
