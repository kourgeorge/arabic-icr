...
Character segmentation is the process of splitting the handwritten script into basic units, usually corresponding to single letters or alternatively to different basic units usually named graphems. Grapheme is the smallest semantically distinguishing unit in a written language, analogous to the phonemes of spoken languages.
...
The problems of segmentation persist today and its importance is derived from the fact that wrong segmentation will often results in major contribution to the error of the recognition algorithm. 
 \cite{casey1996survey, brodowska2011oversegmentation}
