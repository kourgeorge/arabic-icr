...
Arabic handwriting recognition research came to the attention of researchers very recently compared to Latin and Chinese.
...
A summary and future work are given in Chapter . 
As given in Chapter \ref{chap:summary}, in future work we will focus on overcoming these limitations. 
...
The results of this research have been concluded and published in two conference papers co-authored with Dr. Raid Saabni.  

A conference paper titled \emph{"Real-time Segmentation of On-line Handwritten Arabic Script"} will be presented in the \emph{14th International Conference on Frontiers in Handwriting Recognition} (ICFHR-2014). 
It was accepted in April 21, 2014 and will be published in the conference proceedings.

Additional conference paper titled \emph{"Fast Classification of Handwritten On-line Arabic Characters"} was accepted for publication in the \emph{6th International Conference of Soft Computing and Pattern Recognition} (SoCPaR 2014) in June 20, 2014.
