...
But, in order to determine the segmentation, the system may try to seek a pattern that will match a member of the system's alphabet and researches could find themselves, as was described in \cite{casey1996survey}, in a catch 22 situation.
...
The only way to distinguish between the two options is by considering at the delayed strokes and the contextual validity.
