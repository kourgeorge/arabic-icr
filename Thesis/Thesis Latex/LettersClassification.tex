...
\begin{itemize}
\item What is the distance functions between bins that is used in the EMD embedding?
\item is the embedding by Indyk assumes that the number of bins in the two histograms are equal?
\end{itemize}
...
In the original work on EMD, the authors provided more general definition of EMD which does nor assume $|P|=|Q|$. However, Indyk did not consider this generalization, since in such case EMD does not form a metric.
