...
\item Talk about the different classification techniques that is common in handwriting recognition such as NN and HMM.
...
{\color{blue}Distance functions have been proposed for different application, such as Dynamic Time Warping [12, 118, 57, 52], Longest Common Subsequences [13, 108], Edit distance and Earth Mover's distance. 
...
The dissimilarity measure that we have used is the \emph{Earth Movers Distance} (EMD). It has experimentally verified to capture well the perceptual notion of a difference between images.
