...
Res = (length(SimplifiedSequence)>2 && Slope<MaxSlope && Sequence(CurrPoint,1)<Sequence(CurrPoint-1,1));
Res = Res && SPQuerySVM('C:\OCRData\Segmentation\SVM\SVMStruct',Slope);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
